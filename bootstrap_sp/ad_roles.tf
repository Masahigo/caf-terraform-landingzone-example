# Bootstrap - slightly modified version from CAF level0 repo (https://github.com/aztfmod/level0/tree/master/bootstrap)
...
# Contributor role to current subscription

resource "azurerm_role_assignment" "set_rbac_role" {
